...
> ⚠️ АРХИВ. Этот файл создан на раннем этапе проекта.
> Характер персонажа здесь УСТАРЕЛ (нет Люцифер-рефрейма, нет правил мира).
>
> АКТУАЛЬНЫЕ ИСТОЧНИКИ:
> — Характер, архетип, правила: [TIGER_BIBLE.md](TIGER_BIBLE.md)
> — Промпт-блоки для быстрой работы: [../../TIGER_START_HERE.md](../../TIGER_START_HERE.md)
>
> Разделы 9 и 10 (шаблоны промптов, быстрые строки) перенесены в TIGER_START_HERE.md.
> Этот файл оставлен для справки по разделам 1-8 (стили, лайтинг, CN-блоки).
